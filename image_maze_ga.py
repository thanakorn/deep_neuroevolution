...
ga = SimpleGA(num_populations=num_populations,fitness_evaluator=evaluator, selection_pressure=0.15, mutation_prob=1.0, mutation_power=0.005, crossover_prob=0.5)
