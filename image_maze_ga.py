...
ga = SimpleGA(num_populations=num_populations,fitness_evaluator=evaluator, selection_pressure=0.1, 
              mutation_prob=1.0, mutation_power=0.05, crossover_prob=0.5)

ray.init()
solution = ga.run(populations=init_populations, num_generations=400, num_workers=4, max_iterations=150, run_mode='multiprocess', visualize=False)
ray.shutdown()
