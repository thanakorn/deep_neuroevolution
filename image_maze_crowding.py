...
ga = DeterministicCrowdingGA(num_populations=num_populations,fitness_evaluator=evaluator, selection_pressure=0.1, mutation_prob=0.2, mutation_power=0.002, crossover_prob=0.5)
